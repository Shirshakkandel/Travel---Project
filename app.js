...
function animateSlides() {
  ...
  sliders.forEach((slide, index, slides) => {
    ...
    //-=1 means it will animated 1 second sooner.
    ...
    slideScene = new ScrollMagic.Scene({
      ...
      triggerHook: 0.25,
      reverse: false, //single time animation.
    })
      //we add timeline slideTl
      .setTween(slideTl)
      // .addIndicators({
      //   colorStart: "white",
      //   colorTrigger: "white",
    ...
    pageScene = new ScrollMagic.Scene({
      ...
      .setTween(pageTl) //add page timeline
      .addTo(controller);
  });
}

//COMMENT::Cursor Animation
const mouse = document.querySelector('.cursor');
const mouseTxt = mouse.querySelector('span');
const burger = document.querySelector('.burger');
//at event listener of mousemove we move mouse position
function cursor(e) {
  mouse.style.top = e.pageY + 'px';
  mouse.style.left = e.pageX + 'px';
}
//at event listener of mouseover or hover we activate
//with poineter event none we add burger class.
...
//navbar animation with two line and clippath change.
